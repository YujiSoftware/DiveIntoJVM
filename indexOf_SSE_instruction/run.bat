...
"%JAVA_HOME%\bin\java" -jar test/target/benchmarks.jar -jvmArgs "-XX:+UnlockDiagnosticVMOptions -XX:+TraceClassLoading -XX:+LogCompilation -XX:+PrintAssembly -XX:+UseSSE42Intrinsics -XX:LogFile=SSE42_ON.log"  -wi 5 -w 3 -i 5 -r 3 -f 1
"%JAVA_HOME%\bin\java" -jar test/target/benchmarks.jar -jvmArgs "-XX:+UnlockDiagnosticVMOptions -XX:+TraceClassLoading -XX:+LogCompilation -XX:+PrintAssembly -XX:-UseSSE42Intrinsics -XX:LogFile=SSE42_OFF.log" -wi 5 -w 3 -i 5 -r 3 -f 1
